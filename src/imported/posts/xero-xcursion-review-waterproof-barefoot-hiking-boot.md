...
description: ¡Xero Shoes está lanzando una versión actualizada de su bota de montaña
  ...
  la bota de senderismo impermeable y de zero drop Xero Xcursion.
date: '2021-03-11T19:45:17'
permalink: /xero-xcursion-review-waterproof-barefoot-hiking-boot/
sourceType: Artículo
contentType: Artículo
sourceId: 13022
sourceSlug: xero-xcursion-review-waterproof-barefoot-hiking-boot
sourceModified: '2026-06-13T00:23:08'
image: "/assets/generated/featured/posts/xero-xcursion-review-waterproof-barefoot-hiking-boot.jpg"
imageAlt: "Imagen destacada de 'Revisión de Xero Xcursion Fusion: una bota de senderismo impermeable y de"
tags:
- traducido
language: es
translatedFrom: en
---
<p> ¡está lanzando una versión actualizada de su bota de senderismo Xcursion Waterproof! Probé la versión anterior el año pasado, así que estoy emocionado de ver cómo se compara el nuevo Xcursion. <strong>Siga leyendo para conocer mi reseña de esta bota de senderismo impermeable y de zero drop de Xero Shoes: la Xcursion.</strong></p>
<div class="wp-block-uagb-table-of-contents uagb-toc__align-left uagb-toc__columns-1 uagb-block-5e695be0" data-offset="30" data-scroll="1" style="">
<div class="uagb-toc__wrap">
<div class="uagb-toc__title">
							Tabla de contenidos						</div>
<div class="uagb-toc__list-wrap">
<ol class="uagb-toc__list"><li class="uagb-toc__list"><a class="uagb-toc-link__trigger" href="#xero-xcursion-review">Revisión de Xero Xcursion</a><ul class="uagb-toc__list"><li class="uagb-toc__list"><a class="uagb-toc-link__trigger" href="#specs">Especificaciones</a><li class="uagb-toc__list"><li class="uagb-toc__list"><a class="uagb-toc-link__trigger" href="#flexibility">Flexibilidad</a><li class="uagb-toc__list"><li class="uagb-toc__list"><a class="uagb-toc-link__trigger" href="#fit-type">Tipo de ajuste</a><li class="uagb-toc__list"><li class="uagb-toc__list"><a class="uagb-toc-link__trigger" href="#sizing">Dimensionamiento</a><li class="uagb-toc__list"><li class="uagb-toc__list"><a class="uagb-toc-link__trigger" href="#waterproof">¿Impermeable?</a><li class="uagb-toc__list"><li class="uagb-toc__list"><a class="uagb-toc-link__trigger" href="#xcursion-vs-other-barefoot-hikers">Xcursion frente a otros excursionistas descalzos</a><li class="uagb-toc__list"><li class="uagb-toc__list"><a class="uagb-toc-link__trigger" href="#conclusion">Conclusión</a></li></li></li></li></li></li></li></li></li></li></li></li></li></ul></li></ol> </div>
</div>
</div>
...
<p>Estas botas son 100% veganas, fabricadas en malla y poliéster. La altura total del calzado es de 11 cm, con tacos para tracción y plantilla extraíble. Los materiales son duraderos y buenos para un uso resistente.</p>
<h3 class="wp-block-heading">Flexibilidad</h3>

<p>La Xero Xcursion es definitivamente más flexible que las botas de montaña tradicionales y más rígidas que la mayoría de las otras botas de montaña descalzas que he probado. Los zapatos Xero se adaptan con el tiempo y se ablandan, pero al principio son bastante rígidos.</p>
<h3 class="wp-block-heading">Tipo de ajuste</h3>

<p>Los zapatos Xero encajan <strong>volumen medio a alto</strong> (bueno para pies altos/llenos) y tener un <strong>puntera redondeada/de montaña</strong> (bueno para segundos dedos largos). Por lo general, los zapatos Xero se ajustan a una puntera de ancho medio y a un mediopié y talón anchos (lo que significa que son anchos en todo el zapato y no se estrechan en ninguna parte). <strong>Las nuevas Xcursions son más estrechas que otras zapatillas Xero.</strong> Lo intenté y tuve que aumentar el tamaño para el ancho. Consulte la comparación más adelante para obtener más detalles.</p>
